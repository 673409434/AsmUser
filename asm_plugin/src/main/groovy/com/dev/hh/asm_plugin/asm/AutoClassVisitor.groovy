...
public class AutoClassVisitor extends ClassVisitor {
    ...
    void visit(int version, int access, String name, String signature, String superName, String[] interfaces) {
        ...
        // 打印调试信息
        println("\n||---开始扫描类：${mClassName}")
        println("||---类详情：version=${version};\taccess=${Logger.accCode2String(access)};\tname=${name};\tsignature=${signature};\tsuperName=${superName};\tinterfaces=${interfaces.toArrayString()}")
...
//            println("visitedFragMethods:" + visitedFragMethods)
            while (iterator.hasNext()) {
                ...
                println("||Hooked class:injected method:" + methodCell.agentName)
